import { useState } from 'react';
    import { Twitter, MessageCircle, Github, ArrowRight, Download, Zap, Rocket, ShoppingCart, Flame } from 'lucide-react';
        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <header className="relative z-10 container mx-auto px-4 py-6 flex justify-between items-center">
            ...
            <nav className="hidden md:block">
              <ul className="flex gap-8">
                ...
                <li><a href="#tokenomics" className="hover:text-blue-400 transition-colors">Roadmap</a></li>
                <li><a href="#community" className="hover:text-blue-400 transition-colors">About</a></li>
              </ul>
            </nav>
            ...
            {isMenuOpen && (
              <div className="absolute top-full left-0 right-0 bg-gray-900 p-4 md:hidden z-50">
                <ul className="flex flex-col gap-4">
                  ...
                  <li><a href="#tokenomics" className="block py-2 hover:text-blue-400 transition-colors" onClick={() => setIsMenuOpen(false)}>Roadmap</a></li>
                  <li><a href="#community" className="block py-2 hover:text-blue-400 transition-colors" onClick={() => setIsMenuOpen(false)}>About</a></li>
                </ul>
              </div>
            )}
          </header>
          ...
          <section className="relative z-10 container mx-auto px-4 py-20 flex flex-col items-center text-center">
            ...
            <div className="relative mb-10 flex items-center justify-center">
              ...
              <div className="w-40 h-40 rounded-full border-4 border-blue-500 shadow-lg shadow-blue-500/50 ml-4 relative z-10" style={{ clipPath: 'circle(35%)' }}>
                <img
                  src="https://cdn.glitch.global/cdada319-8cc1-41a7-ab15-329ec6fc30a0/memexlogo.jpg"
                  alt="MemeX Logo"
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="flex items-center gap-2 mb-6 md:mb-0">
                  <img
                    ...
                    style={{ clipPath: 'circle(35%)' }}
                  />
                  <span className="font-bold text-2xl">MEMEX</span>
                </div>

                <div className="flex gap-4 mb-6 md:mb-0">
                  <a href="https://x.com/memexairdrop" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-500 transition-colors">
                    <Twitter className="w-5 h-5" />
                  </a>
                  <a href="https://t.me/memexairdropchannel" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-500 transition-colors">
                    <MessageCircle className="w-5 h-5" />
                  </a>
                </div>

                <div className="text-gray-400 text-center md:text-right">
                  <p>© 2025 MemeX Token. All rights reserved.</p>
                  <p className="text-sm mt-1">Not financial advice. DYOR.</p>
                </div>
              </div>
            </div>
          </footer>
