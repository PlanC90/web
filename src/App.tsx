        ...
        <header className="relative z-10 container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-8">
              ...
              <li><a href="#roadmap" className="hover:text-blue-400 transition-colors">Community</a></li>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center gap-2 mb-6 md:mb-0">
                ...
                />
                <span className="font-bold text-xl">MEMEX</span>
              </div>
              <div className="flex gap-8">
                <a href="https://twitter.com/memex_community" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
                  <Twitter />
                </a>
                <a href="https://discord.com/invite/memex" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
                  <MessageCircle />
                </a>
                <a href="https://github.com/memex" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
                  <Github />
                </a>
              </div>
            </div>
